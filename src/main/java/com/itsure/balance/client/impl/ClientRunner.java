package com.itsure.balance.client.impl;

import com.itsure.balance.BalanceProvider;
import com.itsure.balance.IClient;
import com.itsure.balance.ServerData;
import com.itsure.balance.balance.impl.DefaultBalanceProvider;
...
public class ClientRunner {
		...
		public static void main(String[] args) {
			...
			final List<IClient> clientList = new ArrayList<>();
			...
			try{
				...
				for(int i=0; i<CLIENT_QTY; i++){
					...
					Thread thread = new Thread(new Runnable() {
						...
						public void run() {					
							IClient client = new ClientImpl(balanceProvider);
